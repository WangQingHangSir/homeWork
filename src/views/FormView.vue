<template>
  <div>
    <wqh-form inline :item="formItem" :field="formFiled" :button="formButton" :beforeSubmit="handleSearchSubmit"></wqh-form>
    <wqh-table :format="tableFormat" initRequest :column="column" index url="/article/advert/search" method="POST">
...
export default {
  name: 'FormView',
  components: {
    wqhForm: () => import('../components/form/index.vue'),
